...
(function($) {
  ...
  class GallerySection extends HTMLElement {
    ...
    load() {
      ...
      var $gallery = this.$container.find('.gallery'),
      ...
      $gallery.find('.fotorama__arr--prev').append($('<i>').append(theme.Global.getIcon('006')));
      $gallery.find('.fotorama__arr--next').append($('<i>').append(theme.Global.getIcon('007')));
      $gallery.find('.fotorama__fullscreen-icon').append($('<i>').append(theme.Global.getIcon('164')));
